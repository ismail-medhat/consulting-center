        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Group List
                    <a href="{{ route('group.allocate') }}" style="color: #FFF;border-radius: 10px;box-shadow:4px 4px 4px rgb(199, 199, 192);" class="btn btn btn-warning float-right m-1" ><i class="far fa-arrow-left"> All Courses</i></a>
                </h6>
                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr>
                            ...
                            <th class="wd-15p">Payment Month</th>
