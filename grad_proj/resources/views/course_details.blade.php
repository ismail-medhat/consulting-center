                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        ...
                        <div class="ml-12" style="margin:50px;text-align: center; ">
                            ...
                            <span  style="font-size: 22px;">Post Date : <span class="badge badge-secondary">{{ Carbon\Carbon::parse($course->created_at)->diffForHumans() }}</span></span>
                        </div>
                        ...
                        <a href="{{ route('view.courses') }}" class="btn btn-success" style="margin:0px 180px; ">
